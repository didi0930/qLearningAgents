...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in legalActions:
            QList[action] = self.getQValue(state, action)
        return QList[QList.argMax()]
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feature in featureFunction:
            Q += self.weights[feature] * featureFunction[feature]
        return Q
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in featureFunction:
            self.weights[feature] += self.alpha*featureFunction[feature]*difference
